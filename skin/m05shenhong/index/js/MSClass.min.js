...
delete(msobj.tempHTML);msobj.Direction>1?msobj.ID.scrollLeft=0:msobj.ID.scrollTop=0;msobj.TimerID=setInterval(msobj.StartID,timer);if(msobj.ScrollStep<0)return;msobj.ID.onmousemove=function(event)
