...
<ul class="cf"> 
<li><dl><dt><a href="<?php echo $MODULE['1']['linkurl'];?>" title="<?php echo $DT['sitename'];?>">首页<i>HOMEPAGE</i></a></dt></dl></li>
<li><dl><dt><a href="<?php echo $MODULE['4']['linkurl'];?>" target="_blank">名企汇<i>SUPPLY</i><em></em></a></dt></dl></li>
<li><dl><dt><a href="<?php echo $MODULE['5']['linkurl'];?>" target="_blank">产品库<i>SELECT</i><em></em></a></dt> </dl></li>
<li><dl><dt><a href="<?php echo $MODULE['6']['linkurl'];?>" target="_blank">爱采购<i>BATHWARE</i><em></em></a></dt></dl></li> 
<li><dl><dt><a href="<?php echo $MODULE['13']['linkurl'];?>" target="_blank">品牌汇<i>BRANDS</i><em></em></a></dt></dl></li>
<li><dl><dt><a href="<?php echo $MODULE['21']['linkurl'];?>" target="_blank">企商讯<i>NEWS</i><em></em></a></dt></dl></li>
<li><dl><dt class="yzs"><a href="<?php echo $MODULE['22']['linkurl'];?>" target="_blank">云招商<i>MERCHANTS</i><em></em></a><u></u></dt></dl></li> 
 
 
<li><dl><dt><a href="<?php echo $MODULE['9']['linkurl'];?>" class="nav-sd" target="_blank">聘人才<i>MALL</i></a></dt></dl></li> 
</ul> 
</div> 
</div>
