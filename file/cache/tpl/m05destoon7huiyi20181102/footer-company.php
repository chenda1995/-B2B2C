<?php defined('IN_DESTOON') or exit('Access Denied');?><div class="wy-wrap"> 
<div class="h5"></div>
<div class="wy-tt8">
<i></i>
<h2>友情链接</h2>
...
<script type="text/javascript" src="<?php echo DT_SKIN;?>js/news-v1.3.1.js"></script>
<script type="text/javascript" src="<?php echo DT_SKIN;?>js/company.js"></script>
<script type="text/javascript" src="<?php echo DT_SKIN;?>js/page.js"></script>
<script type="text/javascript" src="<?php echo DT_SKIN;?>js/MSClass.js"></script>
...
<script type="text/javascript" src="<?php echo DT_SKIN;?>js/bd-dialog.js"></script> 
